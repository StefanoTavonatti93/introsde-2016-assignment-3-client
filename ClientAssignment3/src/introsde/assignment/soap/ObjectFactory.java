...
public class ObjectFactory {
    ...
    private final static QName _MeasureTypes_QNAME = new QName("http://soap.assignment.introsde/", "measureTypes");
    private final static QName _CreatePerson_QNAME = new QName("http://soap.assignment.introsde/", "createPerson");
    private final static QName _HealthProfileHistory_QNAME = new QName("http://soap.assignment.introsde/", "healthProfile-history");
    private final static QName _UpdatePersonMeasure_QNAME = new QName("http://soap.assignment.introsde/", "updatePersonMeasure");
    private final static QName _People_QNAME = new QName("http://soap.assignment.introsde/", "people");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.assignment.introsde/", name = "measureTypes")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap.assignment.introsde/", name = "healthProfile-history")
